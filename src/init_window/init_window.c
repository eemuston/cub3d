...
/*   Updated: 2023/10/09 17:36:20 by eemuston         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	init_window(t_cub3d *data)
{
	...
	data->texture[NORTH - 1].data = (int *)mlx_get_data_addr(data->texture[NORTH - 1].img,
			&data->texture[NORTH - 1].bpp, &data->texture[NORTH - 1].size_line,
	...
	data->texture[SOUTH - 1].data = (int *)mlx_get_data_addr(data->texture[SOUTH - 1].img,
			&data->texture[SOUTH - 1].bpp, &data->texture[SOUTH - 1].size_line,
	...
	data->texture[WEST - 1].data = (int *)mlx_get_data_addr(data->texture[WEST - 1].img,
			&data->texture[WEST - 1].bpp, &data->texture[WEST - 1].size_line,
	...
	data->texture[EAST - 1].data = (int *)mlx_get_data_addr(data->texture[EAST - 1].img,
			&data->texture[EAST - 1].bpp, &data->texture[EAST - 1].size_line,
